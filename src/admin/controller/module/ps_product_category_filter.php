...
class PsProductCategoryFilter extends \Opencart\System\Engine\Controller
{
     ...
     */
    const GITHUB_REPO_URL = 'https://github.com/playfulsparkle/oc4_product_category_filter';
    ...
    public function index(): void
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/ps_product_category_filter/module/ps_product_category_filter', 'user_token=' . $this->session->data['user_token'], true),
        ];
